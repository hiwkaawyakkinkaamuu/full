...
type FirstLoginRequest struct {
	...
	StudentNumber string `json:"student_number,omitempty" form:"student_number"`
	FacultyID     uint   `json:"faculty_id,omitempty" form:"faculty_id"`
	DepartmentID  uint   `json:"department_id,omitempty" form:"department_id"`

	// Organization fields (สำหรับเมลอื่นๆ)
	OrganizationName     string `json:"organization_name,omitempty" form:"organization_name"`
	OrganizationType     string `json:"organization_type,omitempty" form:"organization_type"`
	OrganizationLocation string `json:"organization_location,omitempty" form:"organization_location"`
	OrganizationPhone    string `json:"organization_phone,omitempty" form:"organization_phone"`
}
